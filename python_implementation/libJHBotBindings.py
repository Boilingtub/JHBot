...
post_data.argtypes = [c_char_p,POINTER(c_char_p),c_ulong,c_char_p,c_char_p]
...
create_new_ssl_listner_server.argtypes = [c_int,c_int,c_int,c_ulong,c_int,c_int,c_char_p]
